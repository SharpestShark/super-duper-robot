...
function start() {
  ...
  interactBtnText = new component("18px","Consolas","black",interactBtn.x + 10,interactBtn.y + (interavtBtn.height/2),"text");
  ...
  if (navigator.platform == 'iPad') {
    ...
    interactBtnText = new component("18px","FontAwesome","black",interactBtn.x + 10,interactBtn.y + (interavtBtn.height/2),"text");
...
var x, y, scale, isObstacle;
  ...
  interactBtnText.y = interactBtn.y + (interavtBtn.height/2);
  interactBtn.update();
